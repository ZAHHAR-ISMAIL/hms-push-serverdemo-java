...
//        Notification notification_1 = Notification.builder().setTitle("sample title 1")
//                .setBody("sample message body 1")
//                .build();
//
//        Notification notification_2 = Notification.builder().setTitle("sample title 2")
//                .setBody("sample message body 2")
//                .build();
//
//        JSONObject multiLangKey = new JSONObject();
//        JSONObject titleKey = new JSONObject();
...
//                .build();
//
//        Message message_2 = Message.builder().setNotification(notification_2)
//                .setAndroidConfig(androidConfig)
